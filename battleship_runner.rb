...
# if @player_cruiser.sunk? == true
#   if @player_cruiser.sunk? == true  && @player_submarine.sunk? == false
#     puts "Cruiser was sunk!"
#     puts "Submarine remaining"
#   elsif @player_submarine.sunk? && @comp_cruiser.sunk? == true
#     puts "Submarine and Cruiser sunk!"
#   end
#
# elsif @comp_submarine.sunk? == true
#   if @comp_submarine.sunk? == true && @comp_cruiser.sunk? == false
#     puts "Submarine was sunk!"
#     puts "Cruiser remaining"
#   elsif @comp_cruiser.sunk? == true && @comp_submarine.sunk? == true #|| @player_cruiser.sunk? == true
#     puts "Cruiser and submarine sunk!"
#   end
#
# elsif @player_cruiser.sunk?
#   if @player_cruiser.sunk? && @player_submarine.sunk? == false
#     puts "Cruiser was sunk!"
#     puts "Submarine remaining"
#   elsif @player_submarine.sunk? == true && @player_submarine.sunk? == true
#     puts "Submarine and Cruiser sunk!"
#   end
#
# elsif @player_submarine.sunk? == true
#   if @player_submarine.sunk? == true&& @player_cruiser.sunk? == false
#     puts "Submarine was sunk!"
#     puts "Cruiser remaining"
